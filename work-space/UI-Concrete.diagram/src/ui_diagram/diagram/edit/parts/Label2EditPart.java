...
public class Label2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ui_diagram.diagram.edit.policies.Label2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ui_diagram.diagram.edit.parts.LabelText2EditPart) {
			((ui_diagram.diagram.edit.parts.LabelText2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureLabelLabelFigure());
			return true;
		}
		return false;
	}
