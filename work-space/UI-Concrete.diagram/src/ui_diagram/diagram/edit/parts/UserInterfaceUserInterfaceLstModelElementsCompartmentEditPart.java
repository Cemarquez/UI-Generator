	...
	*/
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == ui_diagram.diagram.providers.Ui_diagramElementTypes.Button_3010) {
				return this;
			}
			if (type == ui_diagram.diagram.providers.Ui_diagramElementTypes.Label_3011) {
				return this;
			}
			if (type == ui_diagram.diagram.providers.Ui_diagramElementTypes.CheckBox_3012) {
				return this;
			}
			if (type == ui_diagram.diagram.providers.Ui_diagramElementTypes.TextInput_3013) {
				return this;
			}
			if (type == ui_diagram.diagram.providers.Ui_diagramElementTypes.Image_3014) {
				return this;
			}
			if (type == ui_diagram.diagram.providers.Ui_diagramElementTypes.List_3015) {
				return this;
			}
			if (type == ui_diagram.diagram.providers.Ui_diagramElementTypes.RadioButton_3016) {
				return this;
			}
