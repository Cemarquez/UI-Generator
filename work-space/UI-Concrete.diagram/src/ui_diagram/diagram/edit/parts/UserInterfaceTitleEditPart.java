...
public class UserInterfaceTitleEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ui_diagram.diagram.edit.policies.Ui_diagramTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return ui_diagram.diagram.providers.Ui_diagramElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ui_diagram.diagram.providers.Ui_diagramParserProvider.getParser(
					ui_diagram.diagram.providers.Ui_diagramElementTypes.UserInterface_2001, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					ui_diagram.diagram.edit.parts.Ui_diagramEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
