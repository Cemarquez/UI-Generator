 ...
 * @generated
 */
public class GroupItemSemanticEditPolicy extends ui_diagram.diagram.edit.policies.Ui_diagramBaseItemSemanticEditPolicy {
	...
	*/
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (ui_diagram.diagram.part.Ui_diagramVisualIDRegistry.getVisualID(node)) {
			case ui_diagram.diagram.edit.parts.GroupGroupLstChildModelElementsCompartmentEditPart.VISUAL_ID:
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					Node cnode = (Node) cit.next();
					switch (ui_diagram.diagram.part.Ui_diagramVisualIDRegistry.getVisualID(cnode)) {
