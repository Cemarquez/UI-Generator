	...
	*/
	private IParser getGroupTitle_5009Parser() {
		if (groupTitle_5009Parser == null) {
			EAttribute[] features = new EAttribute[] { ui_diagram.Ui_diagramPackage.eINSTANCE.getGroup_Title() };
			ui_diagram.diagram.parsers.MessageFormatParser parser = new ui_diagram.diagram.parsers.MessageFormatParser(
					features);
	...
	*/
	private IParser getButtonText_5001Parser() {
		if (buttonText_5001Parser == null) {
			EAttribute[] features = new EAttribute[] { ui_diagram.Ui_diagramPackage.eINSTANCE.getButton_Text() };
			ui_diagram.diagram.parsers.MessageFormatParser parser = new ui_diagram.diagram.parsers.MessageFormatParser(
					features);
	...
	*/
	private IParser getLabelText_5002Parser() {
		if (labelText_5002Parser == null) {
			EAttribute[] features = new EAttribute[] { ui_diagram.Ui_diagramPackage.eINSTANCE.getLabel_Text() };
			ui_diagram.diagram.parsers.MessageFormatParser parser = new ui_diagram.diagram.parsers.MessageFormatParser(
					features);
	...
	*/
	private IParser getCheckBoxName_5003Parser() {
		if (checkBoxName_5003Parser == null) {
			EAttribute[] features = new EAttribute[] { ui_diagram.Ui_diagramPackage.eINSTANCE.getModelElement_Name() };
			ui_diagram.diagram.parsers.MessageFormatParser parser = new ui_diagram.diagram.parsers.MessageFormatParser(
					features);
	...
	*/
	private IParser getTextInputText_5004Parser() {
		if (textInputText_5004Parser == null) {
			EAttribute[] features = new EAttribute[] { ui_diagram.Ui_diagramPackage.eINSTANCE.getTextInput_Text() };
			ui_diagram.diagram.parsers.MessageFormatParser parser = new ui_diagram.diagram.parsers.MessageFormatParser(
					features);
