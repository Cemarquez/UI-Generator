 ...
 * 
 */
package ui_concrete.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(ui_concrete.diagram.part.Ui_concreteDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(ui_concrete.diagram.part.Messages.MessageFormatParser_InvalidInputError,
