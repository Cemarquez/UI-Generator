 ...
 * @generated
 */
public class RadioButtonText2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RadioButtonText2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ui_concrete.diagram.edit.policies.Ui_concreteTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return ui_concrete.diagram.providers.Ui_concreteElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ui_concrete.diagram.providers.Ui_concreteParserProvider.getParser(
					ui_concrete.diagram.providers.Ui_concreteElementTypes.RadioButton_3016, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					ui_concrete.diagram.edit.parts.Ui_concreteEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
