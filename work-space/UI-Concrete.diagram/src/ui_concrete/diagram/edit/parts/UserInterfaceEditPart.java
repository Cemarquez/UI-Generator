...
public class UserInterfaceEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ui_concrete.diagram.edit.parts.UserInterfaceTitleEditPart) {
			((ui_concrete.diagram.edit.parts.UserInterfaceTitleEditPart) childEditPart)
