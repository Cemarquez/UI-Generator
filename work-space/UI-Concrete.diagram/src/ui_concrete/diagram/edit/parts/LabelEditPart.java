...
public class LabelEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ui_concrete.diagram.edit.policies.LabelItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ui_concrete.diagram.edit.parts.LabelTextEditPart) {
			((ui_concrete.diagram.edit.parts.LabelTextEditPart) childEditPart)
	...
	protected void handleNotificationEvent(Notification arg0) {
		...
		if (arg0.getEventType() == Notification.SET) {
			...
			if (arg0.getNotifier() instanceof BoundsImpl) {
				...
				model.setBackgroundColor("#dededddddada");
