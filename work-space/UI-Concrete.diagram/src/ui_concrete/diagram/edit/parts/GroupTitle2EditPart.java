 ...
 * @generated
 */
public class GroupTitle2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public GroupTitle2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ui_concrete.diagram.providers.Ui_concreteParserProvider.getParser(
					ui_concrete.diagram.providers.Ui_concreteElementTypes.Group_3002, getParserElement(),
