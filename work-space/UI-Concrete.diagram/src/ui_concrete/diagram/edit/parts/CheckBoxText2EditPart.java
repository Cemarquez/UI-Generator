 ...
 * @generated
 */
public class CheckBoxText2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CheckBoxText2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ui_concrete.diagram.providers.Ui_concreteParserProvider.getParser(
					ui_concrete.diagram.providers.Ui_concreteElementTypes.CheckBox_3012, getParserElement(),
