 ...
 * @generated
 */
public class RadioButton2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public RadioButton2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ui_concrete.diagram.edit.policies.RadioButton2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new RadioButtonFigure();
	}

	/**
	* @generated
	*/
	public RadioButtonFigure getPrimaryShape() {
		return (RadioButtonFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ui_concrete.diagram.edit.parts.RadioButtonText2EditPart) {
			((ui_concrete.diagram.edit.parts.RadioButtonText2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureRadioButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	 ...
	 * @generated
	 */
	public class RadioButtonFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureRadioButtonLabelFigure;
		...
		private void createContents() {
			...
			fFigureRadioButtonLabelFigure = new WrappingLabel();

			fFigureRadioButtonLabelFigure.setText("RadioButton");

			this.add(fFigureRadioButtonLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureRadioButtonLabelFigure() {
			return fFigureRadioButtonLabelFigure;
		}
	...
	protected void handleNotificationEvent(Notification arg0) {
		...
		if (arg0.getEventType() == Notification.SET) {
			...
			if (arg0.getNotifier() instanceof BoundsImpl) {
				...
				RadioButton model = (RadioButton) node.getElement();
