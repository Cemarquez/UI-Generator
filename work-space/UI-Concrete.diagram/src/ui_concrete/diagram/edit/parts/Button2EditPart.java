...
public class Button2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ui_concrete.diagram.edit.policies.Button2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ui_concrete.diagram.edit.parts.ButtonText2EditPart) {
			((ui_concrete.diagram.edit.parts.ButtonText2EditPart) childEditPart)
	...
	*/
	...
	public class ButtonFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			GridData constraintFFigureButtonLabelFigure = new GridData();
			constraintFFigureButtonLabelFigure.verticalAlignment = GridData.CENTER;
			constraintFFigureButtonLabelFigure.horizontalAlignment = GridData.CENTER;
			constraintFFigureButtonLabelFigure.horizontalIndent = 0;
			constraintFFigureButtonLabelFigure.horizontalSpan = 1;
			constraintFFigureButtonLabelFigure.verticalSpan = 1;
			constraintFFigureButtonLabelFigure.grabExcessHorizontalSpace = true;
			constraintFFigureButtonLabelFigure.grabExcessVerticalSpace = true;
			this.add(fFigureButtonLabelFigure, constraintFFigureButtonLabelFigure);
	...
	* @generated
	*/
	static final Color THIS_BACK = new Color(null, 214, 214, 214);
