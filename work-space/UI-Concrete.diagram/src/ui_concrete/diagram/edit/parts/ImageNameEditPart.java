 ...
 * @generated
 */
public class ImageNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ImageNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ui_concrete.diagram.providers.Ui_concreteParserProvider.getParser(
					ui_concrete.diagram.providers.Ui_concreteElementTypes.Image_3007, getParserElement(),
