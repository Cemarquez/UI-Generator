...
public class ListEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ui_concrete.diagram.edit.policies.ListItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ui_concrete.diagram.edit.parts.ListNameEditPart) {
			((ui_concrete.diagram.edit.parts.ListNameEditPart) childEditPart)
	...
	protected void handleNotificationEvent(Notification arg0) {
		...
		if (arg0.getEventType() == Notification.SET) {
			...
			if (arg0.getNotifier() instanceof BoundsImpl) {
				...
				List model = (List) node.getElement();
