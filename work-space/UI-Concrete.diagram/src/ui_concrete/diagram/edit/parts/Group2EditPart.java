...
public class Group2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ui_concrete.diagram.edit.policies.Group2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ui_concrete.diagram.edit.parts.GroupTitle2EditPart) {
			((ui_concrete.diagram.edit.parts.GroupTitle2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureGroupLabelFigure());
			return true;
		}
		if (childEditPart instanceof ui_concrete.diagram.edit.parts.GroupGroupLstChildModelElementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getGroupLstChildModelElementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(
					((ui_concrete.diagram.edit.parts.GroupGroupLstChildModelElementsCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ui_concrete.diagram.edit.parts.GroupGroupLstChildModelElementsCompartment2EditPart) {
