 ...
 * @generated
 */
public class UserInterfaceItemSemanticEditPolicy
	...
	*/
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (ui_concrete.diagram.part.Ui_concreteVisualIDRegistry.getVisualID(node)) {
			case ui_concrete.diagram.edit.parts.UserInterfaceUserInterfaceLstModelElementsCompartmentEditPart.VISUAL_ID:
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					...
					switch (ui_concrete.diagram.part.Ui_concreteVisualIDRegistry.getVisualID(cnode)) {
