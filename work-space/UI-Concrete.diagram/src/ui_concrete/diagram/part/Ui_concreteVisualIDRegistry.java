	...
	*/
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case ui_concrete.diagram.edit.parts.UserInterfaceEditPart.VISUAL_ID:
			if (ui_concrete.diagram.edit.parts.UserInterfaceTitleEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case ui_concrete.diagram.edit.parts.CheckBoxEditPart.VISUAL_ID:
			if (ui_concrete.diagram.edit.parts.CheckBoxNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ui_concrete.diagram.edit.parts.TextInputEditPart.VISUAL_ID:
			if (ui_concrete.diagram.edit.parts.TextInputTextEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ui_concrete.diagram.edit.parts.ImageEditPart.VISUAL_ID:
			if (ui_concrete.diagram.edit.parts.ImageNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case ui_concrete.diagram.edit.parts.RadioButtonEditPart.VISUAL_ID:
			if (ui_concrete.diagram.edit.parts.RadioButtonNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case ui_concrete.diagram.edit.parts.CheckBox2EditPart.VISUAL_ID:
			if (ui_concrete.diagram.edit.parts.CheckBoxName2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ui_concrete.diagram.edit.parts.TextInput2EditPart.VISUAL_ID:
			if (ui_concrete.diagram.edit.parts.TextInputText2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ui_concrete.diagram.edit.parts.Image2EditPart.VISUAL_ID:
			if (ui_concrete.diagram.edit.parts.ImageName2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case ui_concrete.diagram.edit.parts.RadioButton2EditPart.VISUAL_ID:
			if (ui_concrete.diagram.edit.parts.RadioButtonName2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ui_concrete.diagram.edit.parts.UserInterfaceUserInterfaceLstModelElementsCompartmentEditPart.VISUAL_ID:
