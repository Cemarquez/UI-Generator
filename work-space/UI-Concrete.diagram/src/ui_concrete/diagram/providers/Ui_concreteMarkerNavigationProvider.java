 ...
 * @generated
 */
public class Ui_concreteMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = ui_concrete.diagram.part.Ui_concreteDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ui_concrete.diagram.part.Ui_concreteDiagramEditorUtil.selectElementsInDiagram(editor,
