 ...
 * @generated
 */
public class Ui_concreteValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = ui_concrete.diagram.part.Ui_concreteDiagramEditorPlugin.ID
	...
	*/
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof ui_concrete.diagram.part.Ui_concreteDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && ui_concrete.diagram.edit.parts.UI_DiagramEditPart.MODEL_ID
		...
		*/
		public StatusDecorator(IDecoratorTarget decoratorTarget) {
			...
			try {
				...
				ui_concrete.diagram.part.Ui_concreteDiagramEditorPlugin.getInstance().logError("ViewID access failure", //$NON-NLS-1$
						e);
			}
		}
