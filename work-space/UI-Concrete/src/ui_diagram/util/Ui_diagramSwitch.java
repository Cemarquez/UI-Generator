 ...
 * @generated
 */
public class Ui_diagramSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Ui_diagramPackage.GRAPHICAL_INDIVIDUAL: {
			...
			case Ui_diagramPackage.CHECK_BOX: {
			...
			case Ui_diagramPackage.TEXT_INPUT: {
			...
			case Ui_diagramPackage.RADIO_BUTTON: {
