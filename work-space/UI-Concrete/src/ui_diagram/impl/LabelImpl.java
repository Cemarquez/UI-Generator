 ...
 * </p>
 * <ul>
 *   <li>{@link ui_diagram.impl.LabelImpl#getText <em>Text</em>}</li>
 *   <li>{@link ui_diagram.impl.LabelImpl#getTextFont <em>Text Font</em>}</li>
 *   <li>{@link ui_diagram.impl.LabelImpl#getTextFontSize <em>Text Font Size</em>}</li>
 *   <li>{@link ui_diagram.impl.LabelImpl#getTextFontColor <em>Text Font Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LabelImpl extends GraphicalIndividualImpl implements Label {
	...
	protected EClass eStaticClass() {
		return Ui_diagramPackage.Literals.LABEL;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_diagramPackage.LABEL__TEXT, oldText, text));
	}
	...
	public void setTextFont(String newTextFont) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_diagramPackage.LABEL__TEXT_FONT, oldTextFont, textFont));
	}
	...
	public void setTextFontSize(String newTextFontSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_diagramPackage.LABEL__TEXT_FONT_SIZE, oldTextFontSize, textFontSize));
	}
	...
	public void setTextFontColor(String newTextFontColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_diagramPackage.LABEL__TEXT_FONT_COLOR, oldTextFontColor, textFontColor));
	}
