 ...
 * </p>
 * <ul>
 *   <li>{@link ui_diagram.impl.TextInputImpl#getText <em>Text</em>}</li>
 *   <li>{@link ui_diagram.impl.TextInputImpl#getTextFont <em>Text Font</em>}</li>
 *   <li>{@link ui_diagram.impl.TextInputImpl#getTextFontSize <em>Text Font Size</em>}</li>
 *   <li>{@link ui_diagram.impl.TextInputImpl#getTextFontColor <em>Text Font Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextInputImpl extends GraphicalIndividualImpl implements TextInput {
	...
	protected EClass eStaticClass() {
		return Ui_diagramPackage.Literals.TEXT_INPUT;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_diagramPackage.TEXT_INPUT__TEXT, oldText, text));
	}
	...
	public void setTextFont(String newTextFont) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_diagramPackage.TEXT_INPUT__TEXT_FONT, oldTextFont, textFont));
	}
	...
	public void setTextFontSize(String newTextFontSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_diagramPackage.TEXT_INPUT__TEXT_FONT_SIZE, oldTextFontSize, textFontSize));
	}
	...
	public void setTextFontColor(String newTextFontColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_diagramPackage.TEXT_INPUT__TEXT_FONT_COLOR, oldTextFontColor, textFontColor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ui_diagramPackage.TEXT_INPUT__TEXT:
				return getText();
			case Ui_diagramPackage.TEXT_INPUT__TEXT_FONT:
				return getTextFont();
			case Ui_diagramPackage.TEXT_INPUT__TEXT_FONT_SIZE:
				return getTextFontSize();
			case Ui_diagramPackage.TEXT_INPUT__TEXT_FONT_COLOR:
