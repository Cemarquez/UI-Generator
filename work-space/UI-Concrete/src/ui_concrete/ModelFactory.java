 ...
 * </p>
 * <ul>
 *   <li>{@link ui_concrete.ModelFactory#getLstUI_Diagrams <em>Lst UI Diagrams</em>}</li>
 * </ul>
 *
 * @see ui_concrete.Ui_concretePackage#getModelFactory()
 * @model
 * @generated
 */
public interface ModelFactory extends EObject {
	 ...
	 * The list contents are of type {@link ui_concrete.UI_Diagram}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Lst UI Diagrams</em>' containment reference list.
	 * @see ui_concrete.Ui_concretePackage#getModelFactory_LstUI_Diagrams()
