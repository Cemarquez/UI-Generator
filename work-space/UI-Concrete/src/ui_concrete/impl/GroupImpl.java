 ...
 * </p>
 * <ul>
 *   <li>{@link ui_concrete.impl.GroupImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link ui_concrete.impl.GroupImpl#getTitleFont <em>Title Font</em>}</li>
 *   <li>{@link ui_concrete.impl.GroupImpl#getTitleFontSize <em>Title Font Size</em>}</li>
 *   <li>{@link ui_concrete.impl.GroupImpl#getTitleFontColor <em>Title Font Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GroupImpl extends GraphicalContainerImpl implements Group {
	...
	protected EClass eStaticClass() {
		return Ui_concretePackage.Literals.GROUP;
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretePackage.GROUP__TITLE, oldTitle, title));
	}
	...
	public void setTitleFont(String newTitleFont) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretePackage.GROUP__TITLE_FONT, oldTitleFont, titleFont));
	}
	...
	public void setTitleFontSize(String newTitleFontSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretePackage.GROUP__TITLE_FONT_SIZE, oldTitleFontSize, titleFontSize));
	}
	...
	public void setTitleFontColor(String newTitleFontColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretePackage.GROUP__TITLE_FONT_COLOR, oldTitleFontColor, titleFontColor));
	}
