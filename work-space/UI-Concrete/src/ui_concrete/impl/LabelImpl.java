 ...
 *   <li>{@link ui_concrete.impl.LabelImpl#getTextFont <em>Text Font</em>}</li>
 *   <li>{@link ui_concrete.impl.LabelImpl#getTextFontSize <em>Text Font Size</em>}</li>
 *   <li>{@link ui_concrete.impl.LabelImpl#getTextFontColor <em>Text Font Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LabelImpl extends GraphicalIndividualImpl implements Label {
	...
	public void setTextFont(String newTextFont) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretePackage.LABEL__TEXT_FONT, oldTextFont, textFont));
	}
	...
	public void setTextFontSize(String newTextFontSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretePackage.LABEL__TEXT_FONT_SIZE, oldTextFontSize, textFontSize));
	}
	...
	public void setTextFontColor(String newTextFontColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretePackage.LABEL__TEXT_FONT_COLOR, oldTextFontColor, textFontColor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ui_concretePackage.LABEL__TEXT:
				return getText();
			case Ui_concretePackage.LABEL__TEXT_FONT:
				return getTextFont();
			case Ui_concretePackage.LABEL__TEXT_FONT_SIZE:
				return getTextFontSize();
			case Ui_concretePackage.LABEL__TEXT_FONT_COLOR:
