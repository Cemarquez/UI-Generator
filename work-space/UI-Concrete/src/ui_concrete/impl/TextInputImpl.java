 ...
 *   <li>{@link ui_concrete.impl.TextInputImpl#getTextFont <em>Text Font</em>}</li>
 *   <li>{@link ui_concrete.impl.TextInputImpl#getTextFontSize <em>Text Font Size</em>}</li>
 *   <li>{@link ui_concrete.impl.TextInputImpl#getTextFontColor <em>Text Font Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextInputImpl extends GraphicalIndividualImpl implements TextInput {
	...
	public void setTextFont(String newTextFont) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretePackage.TEXT_INPUT__TEXT_FONT, oldTextFont, textFont));
	}
	...
	public void setTextFontSize(String newTextFontSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretePackage.TEXT_INPUT__TEXT_FONT_SIZE, oldTextFontSize, textFontSize));
	}
	...
	public void setTextFontColor(String newTextFontColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretePackage.TEXT_INPUT__TEXT_FONT_COLOR, oldTextFontColor, textFontColor));
	}
