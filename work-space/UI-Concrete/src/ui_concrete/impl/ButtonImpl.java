 ...
 * </p>
 * <ul>
 *   <li>{@link ui_concrete.impl.ButtonImpl#getText <em>Text</em>}</li>
 *   <li>{@link ui_concrete.impl.ButtonImpl#getTextFont <em>Text Font</em>}</li>
 *   <li>{@link ui_concrete.impl.ButtonImpl#getTextFontSize <em>Text Font Size</em>}</li>
 *   <li>{@link ui_concrete.impl.ButtonImpl#getTextFontColor <em>Text Font Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ButtonImpl extends GraphicalIndividualImpl implements Button {
	...
	protected EClass eStaticClass() {
		return Ui_concretePackage.Literals.BUTTON;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretePackage.BUTTON__TEXT, oldText, text));
	}
	...
	public void setTextFont(String newTextFont) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretePackage.BUTTON__TEXT_FONT, oldTextFont, textFont));
	}
	...
	public void setTextFontSize(String newTextFontSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretePackage.BUTTON__TEXT_FONT_SIZE, oldTextFontSize, textFontSize));
	}
	...
	public void setTextFontColor(String newTextFontColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ui_concretePackage.BUTTON__TEXT_FONT_COLOR, oldTextFontColor, textFontColor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ui_concretePackage.BUTTON__TEXT:
				return getText();
			case Ui_concretePackage.BUTTON__TEXT_FONT:
				return getTextFont();
			case Ui_concretePackage.BUTTON__TEXT_FONT_SIZE:
				return getTextFontSize();
			case Ui_concretePackage.BUTTON__TEXT_FONT_COLOR:
