 ...
 * @generated
 */
public class Ui_concreteSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Ui_concretePackage.GRAPHICAL_INDIVIDUAL: {
			...
			case Ui_concretePackage.BUTTON: {
			...
			case Ui_concretePackage.CHECK_BOX: {
			...
			case Ui_concretePackage.TEXT_INPUT: {
			...
			case Ui_concretePackage.IMAGE: {
				Image image = (Image)theEObject;
				T result = caseImage(image);
				if (result == null) result = caseGraphicalIndividual(image);
				if (result == null) result = caseModelElement(image);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ui_concretePackage.LIST: {
				List list = (List)theEObject;
				T result = caseList(list);
				if (result == null) result = caseGraphicalIndividual(list);
				if (result == null) result = caseModelElement(list);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ui_concretePackage.RADIO_BUTTON: {
