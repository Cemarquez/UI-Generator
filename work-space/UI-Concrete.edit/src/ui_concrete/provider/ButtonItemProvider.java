...
/**
 * This is the item provider adapter for a {@link ui_concrete.Button} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ButtonItemProvider extends GraphicalIndividualItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Ui_concretePackage.Literals.BUTTON__TEXT,
				 true,
				 false,
				 false,
	...
	protected void addTextFontPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Button_textFont_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Button_textFont_feature", "_UI_Button_type"),
				 Ui_concretePackage.Literals.BUTTON__TEXT_FONT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTextFontSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Button_textFontSize_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Button_textFontSize_feature", "_UI_Button_type"),
				 Ui_concretePackage.Literals.BUTTON__TEXT_FONT_SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTextFontColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Button_textFontColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Button_textFontColor_feature", "_UI_Button_type"),
				 Ui_concretePackage.Literals.BUTTON__TEXT_FONT_COLOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
