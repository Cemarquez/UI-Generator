...
public class ButtonItemProvider extends GraphicalIndividualItemProvider {
	...
	protected void addVisiblePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Button_visible_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Button_visible_feature", "_UI_Button_type"),
				 Ui_concretePackage.Literals.BUTTON__VISIBLE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Button.class)) {
			...
			case Ui_concretePackage.BUTTON__VISIBLE:
