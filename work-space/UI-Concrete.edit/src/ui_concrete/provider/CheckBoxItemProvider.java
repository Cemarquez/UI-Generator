...
/**
 * This is the item provider adapter for a {@link ui_concrete.CheckBox} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CheckBoxItemProvider extends GraphicalIndividualItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Ui_concretePackage.Literals.CHECK_BOX__SELECTED,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Ui_concretePackage.Literals.CHECK_BOX__TEXT,
				 true,
				 false,
				 false,
